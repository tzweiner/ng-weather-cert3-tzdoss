...
//             concatMap((actionPayload) =>
//                 this.weatherService.currentConditions$.pipe(
//                     map(() => {
//                         console.log('hehe');
//                         return CurrentConditionsAndZipActions.currentConditionsAndZipRemoved();
//                     }
//                     ),
//                     catchError((error) => {
//                         console.log('error in effect', error);
//                         return of(CurrentConditionsAndZipActions.currentConditionsAndZipRemoveFailure( { error }));
//                         }
//                     )
//                 )
//             )
